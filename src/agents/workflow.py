...
class AgentWorkflow:
    ...
    def full_pipeline(self, question: str, retriever: Dict):
        try:
    ...
    def draw_workflow(self):
        from utils.draw_workflow import draw
        draw(self.compiled_workflow)
    
    def _research_step(self, state: AgentState) -> Dict:
        print(f"[DEBUG] Entered _research_step with question='{state['question']}'")
        result = self.researcher.generate_answer(state["question"], state["documents"])
